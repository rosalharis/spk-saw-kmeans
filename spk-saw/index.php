   ...
   <div class="col-12">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="background-color: gold">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <a class="navbar-brand" href="#" style="color: white; font-weight: bold">SPK K-MEANS & SAW ROSAL</a>
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?halaman=kmeans" style="font-weight: bold">K-Means Clustering</a>
          </li>
          </li>
          <li class="nav-item">
